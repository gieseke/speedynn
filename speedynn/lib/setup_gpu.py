...
current_path = os.path.abspath( __file__ ).split("setup_gpu.py")[0]
...
_nearest_neighbors_feature_selection_gpu = Extension("_nearest_neighbors_feature_selection_gpu",
                   ["nearest_neighbors_feature_selection_float_gpu.i","nearest_neighbors_feature_selection.c","util.c","cpu.c","gpu.c","loss_functions.c"],
...
setup(  name        = "nearest_neighbors_feature_selection_gpu",
        description = "nearest_neighbors_feature_selection_gpu",

        author      = "Fabian Gieseke",
        version     = "0.1",
        ext_modules = [_nearest_neighbors_feature_selection_gpu]
        )
